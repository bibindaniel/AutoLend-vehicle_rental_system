                            ...
                            <div class="col-lg-4 col-md-12 mb-4">
                                <div class="card">
                                    <div class="bg-image hover-zoom ripple shadow-1-strong rounded" style="height: 200px; overflow: hidden;">
                                        ...
                                        <a href="admin_deatiled_rating.php?id=<?=$row1['vehicle_id']?>">
        ...
        <nav class="mt-4" aria-label="Page navigation sample">
            <ul class="pagination">
                <?php if ($current_page > 1) : ?>
                    <li class="page-item"><a class="page-link" href="admin_view_rating.php?page=<?php echo $current_page - 1; ?>">Previous</a></li>
                <?php else : ?>
                ...
                <?php for ($page = $offset; $page <= $max_links; $page++) : ?>
                    ...
                    <?php else : ?>
                        <li class="page-item"><a class="page-link" href="admin_view_rating.php?page=<?php echo $page; ?>"><?php echo $page; ?></a></li>
                    <?php endif; ?>
                <?php endfor; ?>
                ...
                <?php if ($current_page < $number_of_page) : ?>
                    <li class="page-item"><a class="page-link" href="admin_view_rating.php?page=<?php echo $current_page + 1; ?>">Next</a></li>
                <?php else : ?>
