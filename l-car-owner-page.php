...
<?php
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-scroll">
      <div class="container-fluid">
        <a class="navbar-brand" href="#"> <img src="Images/Logo.png" class="me-2" height="50" alt="AutoLend Logo"
            loading="lazy" />
  ...
  <main>
    <div class="container my-4 py-4">
      <div class="h2 text-center">Better Way To Rent out your Cars</div>
      <div class="row my-4 py-4">
        <div class="col">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add Your cars</h5>
              <p class="card-text"><i class="fas fa-cloud-upload fa-7x"></i></p>
            </div>
          </div>
        </div>
        <div class="col ">
        ...
        <div class="col">
          <div class="card">
            <div class="card-body .hover-zoom">
              <h5 class="card-title">Rent your Car</h5>
    ...
    <div class="container section4 my-2 py-2 ">
      <div class="main">
        ...
        <br>
        <br>
        <div class="h2 text-light sec-cont">Do You Want To Rent A Car? So Don't Be Late.</div>
        <button type="button" class="btn btn-primary btn-rounded btn-add-car"> Rent Cars</button>
      </div>
    </div>
        ...
        <div class="row text-center d-flex align-items-stretch">
          <div class="col-md-4 mb-5 mb-md-0 d-flex align-items-stretch">
            <div class="card testimonial-card">
              ...
              <div class="avatar mx-auto bg-white">
                <img src="Images/Testimonial/img (9).webp"
          ...
          <div class="col-md-4 mb-5 mb-md-0 d-flex align-items-stretch">
            <div class="card testimonial-card">
              ...
              <div class="avatar mx-auto bg-white">
                <img src="Images/Testimonial/img (2).webp"
                  class="rounded-circle img-fluid" />
              </div>
              <div class="card-body">
          ...
          <div class="col-md-4 mb-0 d-flex align-items-stretch">
            <div class="card testimonial-card">
              ...
              <div class="avatar mx-auto bg-white">
                <img src="Images/Testimonial/img (1).webp"
                  class="rounded-circle img-fluid" />
              </div>
              <div class="card-body">
...
<footer
  ...
  <div
       ...
       >
    © 2023 Copyright:
    <a class="text-white" href="lpage.php"
       >AutoLend</a
      >
  </div>
  <!-- Copyright -->
