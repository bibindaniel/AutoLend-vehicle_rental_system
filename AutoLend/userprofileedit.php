...
<body>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="avatar-upload">
                                            <div class="avatar-edit">
                                                <input type='file' id="imageUpload" accept=".png, .jpg, .jpeg" name="myimage" />
                                ...
                                <div class="col-md-8">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row pt-1">
                                            ...
                                            <div class="col-6 mb-3">
                                                <div class="form-outline">
                                                    <input type="date" id="DOB" name="dob" class="form-control form-control-lg" value="<?php echo $row1['dob'] ?>" />
    ...
    if (isset($_POST["sub"])) {
        ...
        if ($photo == "") {
            $query1 = "UPDATE `tbl_user` SET `first_name`='$name1',`dob`='$user',`location`='$loc',`email`='$mail',`mobile`='$mob' WHERE  `login_id`='$tmp_id'";
        } else
            $query1 = "UPDATE `tbl_user` SET `first_name`='$name1',`dob`='$user',`location`='$loc',`email`='$mail',`mobile`='$mob',`image`='$photo' WHERE  `login_id`='$tmp_id'";
